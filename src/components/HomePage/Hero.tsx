    ...
    return (
        <section className="relative min-h-screen overflow-hidden">
            ...
            <div
                ...
                md:bg-[linear-gradient(to_right,rgba(27,14,7,0.85)_0%,rgba(27,14,7,0.6)_60%,transparent_100%)]
                lg:bg-[linear-gradient(to_right,rgba(27,14,7,0.85)_0%,rgba(27,14,7,0.4)_55%,transparent_95%)]"
            />
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-16 text-center md:px-12 lg:justify-start lg:px-20 lg:text-left">
                <div className="flex w-full max-w-xl flex-col items-center md:max-w-2xl lg:block lg:max-w-3xl">
                    ...
                    <div className="w-fit max-w-full">
                        ...
                        <div aria-hidden="true" className="mx-auto mt-2 h-[3px] w-[60%] rounded-full bg-gradient-to-r from-[#f4d38a] via-[#d7a953] to-[#a7772f] lg:mx-0" />
                    </div>

                    <div className="mt-6 flex w-full max-w-60 items-center justify-center gap-3 lg:max-w-80 lg:justify-start">

                        <button className="min-w-0 flex-1 cursor-pointer rounded-lg border border-[#d7a953] bg-transparent 
                        px-4 py-3 font-semibold tracking-wide text-[#fff] transition-all duration-300 
                        hover:bg-[#d7a953] hover:text-[#2a160b]
                        focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f4d38a] sm:px-8">
                            Book Now
                        </button>
                        ...
                        px-4 py-3 font-semibold tracking-wide text-[#fff] transition-all duration-300 
                        hover:bg-[#d7a953] hover:text-[#2a160b]
                        focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f4d38a] sm:px-6">
                            Shop
                        </button>
